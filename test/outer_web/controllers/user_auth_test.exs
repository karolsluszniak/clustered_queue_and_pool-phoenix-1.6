defmodule OuterWeb.UserAuthTest do
  use OuterWeb.ConnCase, async: true

  alias Outer.Accounts
  alias OuterWeb.UserAuth
  import Outer.AccountsFixtures

  @remember_me_cookie "_outer_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OuterWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OuterWeb.Endpoint.subscribe(live_socket_id)
